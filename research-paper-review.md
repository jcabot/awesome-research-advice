...
- If target venue is provided, include it as context for all subsequent steps:

> “Review this paper as if it is intended for [TARGET VENUE]. Consider typical standards, expectations, page limits, scope, and audience for this venue.”

- Optional: Load venue profiles (if available) with standards for methodology, novelty, empirical rigor, and formatting.
...
# TODO: What sections should the summary cover? Pick what matters to your team:
# - Problem Statement?
# - Contributions?
# - Methodology?
# - Key Results?
...
6. **Venue Alignment** — Optional: Briefly note whether the approach and claims align with the standards of the target venue.
...
- Be constructive, not dismissive. Every paper represents significant effort.
- Distinguish between fatal flaws and minor issues.
- Back up claims with specific references to the paper (section numbers, figures, equations).
- If the paper is outside your expertise, say so explicitly rather than guessing.
- When comparing to related work, only reference papers you have actual knowledge of.
- Do not fabricate citations or invent paper titles. If unsure, say "there may be related work in [area]" rather than citing a specific fake paper.
- Focus on what LLMs do best: consistency checks, numerical verification, formatting issues. Leave creative and narrative judgment to the human reviewer.
- Do not use generic "act as the harshest reviewer" framing. Instead, be specific about what aspects to critique.
- Act as the most rigorous reviewer of the paper field

## Pre-Submission Review Mode

When the user wants to improve their own paper before submitting:

1. Run all the steps above (read, summarize, consistency checks, analysis)
2. After the first review pass, present findings and let the user address them
3. Re-review the revised version — focus on whether previous issues were fixed and check for new ones introduced
4. Repeat at least once. Two rounds of review-revise catches most issues.
5. On the final pass, do a polish check: grammar, sentence structure, readability, and clarity

This iterative approach is more effective than a single review pass.


## Specialized Reviews

For domain-specific guidance, load the relevant reference file:

- For ML/AI papers: read [./references/ml-review.md](./references/ml-review.md)
- For systems papers: read [./references/systems-review.md](./references/systems-review.md)
- For formal methods papers: read [./references/formal-review.md](./references/formal-review.md)

## Literature Survey Mode (optional)

# TODO: Do you want a mode for comparing multiple papers?
# If yes, define the workflow here.

```
research-paper-review/
├── SKILL.md                          # Draft skill 
├── references/
│   ├── ml-review.md                  # Example : ML/AI-specific review criteria 
│   ├── systems-review.md             # TODO: fill in during session
│   └── formal-review.md             # TODO: fill in during session
└── scripts/                          #helper scripts if needed
```


<img width="1752" height="4763" alt="image" src="https://github.com/user-attachments/assets/97d3b146-c259-4ca2-9436-bc9bd8dd63f8" />
